...
class Arguments(BaseSettings):
    ...
    negatives: str = "0:5:10:25:50:75:100"  # number of negative samples to include in the prompt
    ...
    for num_shots in num_shots_:
        for num_negs in negatives_:
            for seed in seeds_:
                ...
                adapter = NbmeAdapter(segmenter=segmenter, negatives=num_negs, seed=seed)
